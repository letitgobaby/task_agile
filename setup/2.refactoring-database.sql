...
ALTER TABLE `task_agile`.`card` ADD COLUMN `board_id` BIGINT(11) NOT NULL DEFAULT 0 AFTER `id`;
...
ALTER TABLE `task_agile`.`activity` CHANGE COLUMN `board_id` `board_id` BIGINT(11) NULL  COMMENT '' AFTER `card_id`;
-- Change type to support integer value other than 0, 1
ALTER TABLE `task_agile`.`activity` CHANGE COLUMN `type` `type` BIGINT(11) NOT NULL COMMENT '' AFTER `board_id`;
